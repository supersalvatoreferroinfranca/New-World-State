...
const COMMON_PHRASES: Record<string, Record<Language, string>> = {
  ...
  "Official State News & Chronicle": {
    it: "Giornale di Stato & Cronaca Sovrana",
    en: "Official State News & Chronicle",
    fr: "Journal Officiel de l'État & Chronique Souveraine",
    es: "Noticias Oficiales del Estado y Crónica Soberana",
    pt: "Jornal Oficial do Estado e Crônica Soberana",
    ru: "Официальные новости государства и суверенная хроника",
    hi: "आधिकारिक राज्य समाचार एवं संप्रभु क्रॉनिकल",
    bn: "সরকারী রাষ্ট্রীয় সংবাদ এবং সার্বভৌম ক্রনিকল",
    zh: "国家官方新闻与主权编年史",
    ja: "公式国家ニュース＆主権クロニクル",
    ar: "أخبار الدولة الرسمية واليوميات السيادية"
  },
  "News & Chronicle": {
    it: "Notizie & Cronaca",
    en: "News & Chronicle",
    fr: "Actualités & Chronique",
    es: "Noticias y Crónica",
    pt: "Notícias e Crônica",
    ru: "Новости и хроника",
    hi: "समाचार एवं क्रॉनिकल",
    bn: "সংবাদ ও ক্রনিকল",
    zh: "新闻与编年史",
    ja: "ニュース＆クロニクル",
    ar: "الأخبار واليوميات"
  },
  "Official State Information Media": {
    it: "Organo d'Informazione Sovrana",
    en: "Official State Information Media",
    fr: "Organe d'Information Souverain",
    es: "Órgano de Información Soberana",
    pt: "Órgão de Informação Soberana",
    ru: "Орган суверенной информации",
    hi: "आधिकारिक राज्य सूचना माध्यम",
    bn: "সরকারী তথ্য মাধ্যম",
    zh: "主权官方信息机构",
    ja: "主権情報機関",
    ar: "جهاز الإعلام السيادي الرسمية"
  },
  "Official State Press": {
    it: "Stampa Ufficiale dello Stato Sovrano",
    en: "Official State Press",
    fr: "Presse Officielle de l'État Souverain",
    es: "Prensa Oficial del Estado Soberano",
    pt: "Imprensa Oficial do Estado Soberano",
    ru: "Официальная пресса суверенного государства",
    hi: "संप्रभु राज्य का आधिकारिक प्रेस",
    bn: "সার্বভৌম রাষ্ট্রের অফিসিয়াল প্রেস",
    zh: "主权国家官方出版物",
    ja: "主権国家公式プレス",
    ar: "الصحافة الرسمية للدولة السيادية"
  },
  "Latest State News & Chronicle": {
    it: "Ultime Notizie dello Stato & Cronaca",
    en: "Latest State News & Chronicle",
    fr: "Dernières Actualités de l'État & Chronique",
    es: "Últimas Noticias del Estado y Crónica",
    pt: "Últimas Notícias do Estado e Crônica",
    ru: "Последние новости государства и хроника",
    hi: "नवीनतम राज्य समाचार एवं क्रॉनिकल",
    bn: "সর্বশেষ রাজ্য সংবাদ ও ক্রনিকল",
    zh: "最新国家新闻与编年史",
    ja: "最新の国家ニュース＆クロニクル",
    ar: "أحدث أخبار الدولة واليوميات"
  },
  "Sovereign News": {
    it: "Notizie Sovrane",
    en: "Sovereign News",
  ...
  "Reporter & Digital Custodian": {
    it: "Cronista & Custode Digitale",
    en: "Reporter & Digital Custodian",
    fr: "Rapporteur & Custode Numérique",
    es: "Cronista y Custodio Digital",
    pt: "Repórter e Custódio Digital",
    ru: "Репортер и цифровой хранитель",
    hi: "रिपोर्टर और डिजिटल कस्टोडियन",
    bn: "রিপোর্টার এবং ডিজিটাল কাস্টোডিয়ান",
    zh: "记者与数字监护人",
    ja: "特派員＆デジタルカストディアン",
    ar: "المراسل والوصي الرقمي"
  },
  "Official Reporter": {
    ...
    es: "Cronista Oficial",
    pt: "Repórter Oficial",
    ru: "Официальный хроникер",
    hi: "आधिकारिक रिपोर्टर",
    bn: "অফিসিয়াল রির্পোটার",
    zh: "官方记者",
    ja: "公式特派員",
    ar: "المراسل الرسمي"
  },
  "Digital Custodian": {
    it: "Custode Digitale",
    en: "Digital Custodian",
    fr: "Custode Numérique",
    es: "Custodio Digital",
    pt: "Custódio Digital",
    ru: "Цифровой хранитель",
    hi: "डिजिटल कस्टोडियन",
    bn: "ডিজিটাল কাস্টোডিয়ান",
    zh: "数字监护人",
    ja: "デジタルカストディアン",
    ar: "الوصي الرقمي"
  },
  "Citizen / Reader": {
    it: "Cittadino / Lettore",
    en: "Citizen / Reader",
    fr: "Citoyen / Lecteur",
    es: "Ciudadano / Lector",
    pt: "Cidadão / Leitor",
    ru: "Гражданин / Читатель",
    hi: "नागरिक / पाठक",
    bn: "নাগরিক / পাঠক",
    zh: "公民 / 读者",
    ja: "市民 / 読者",
  ...
  "Simulate Roles for Testing:": {
    it: "Simula Ruoli per Test:",
    en: "Simulate Roles for Testing:",
    fr: "Simuler les Rôles pour Test :",
    es: "Simular Roles para Pruebas:",
    pt: "Simular Funções para Teste:",
    ru: "Симуляция ролей для тестирования:",
    hi: "परीक्षण के लिए भूमिकाओं का अनुकरण:",
    bn: "পরীক্ষার জন্য ভূমিকা সিমুলেট করুন:",
    zh: "测试角色模拟：",
    ja: "テスト用ロールシミュレーション：",
    ar: "محاكاة الأدوار للاختبار:"
  },
  "✓ Reporter Role Active": {
    it: "✓ Ruolo Cronista Attivo",
    en: "✓ Reporter Role Active",
    fr: "✓ Rôle Rapporteur Actif",
    es: "✓ Rol Cronista Activo",
    pt: "✓ Função Repórter Ativa",
    ru: "✓ Роль репортера активна",
    hi: "✓ रिपोर्टर भूमिका सक्रिय",
    bn: "✓ রিপোর্টার ভূমিকা সক্রিয়",
    zh: "✓ 记者角色已激活",
    ja: "✓ 特派員ロール有効",
    ar: "✓ دور المراسل نشط"
  },
  "+ Activate Reporter Role": {
    it: "+ Attiva Ruolo Cronista",
    en: "+ Activate Reporter Role",
    fr: "+ Activer Rôle Rapporteur",
    es: "+ Activar Rol Cronista",
    pt: "+ Ativar Função Repórter",
    ru: "+ Активировать роль репортера",
    hi: "+ रिपोर्टर भूमिका सक्रिय करें",
    bn: "+ রিপোর্টার ভূমিকা সক্রিয় করুন",
    zh: "+ 激活记者角色",
    ja: "+ 特派員ロールを有効化",
    ar: "+ تفعيل دور المراسل"
  },
  "✓ Custodian Role Active": {
    it: "✓ Ruolo Custode Attivo",
    en: "✓ Custodian Role Active",
    fr: "✓ Rôle Custode Actif",
    es: "✓ Rol Custodio Activo",
    pt: "✓ Função Custódio Ativa",
    ru: "✓ Роль хранителя активна",
    hi: "✓ कस्टोडियन भूमिका सक्रिय",
    bn: "✓ কাস্টোডিয়ান ভূমিকা সক্রিয়",
    zh: "✓ 监护人角色已激活",
    ja: "✓ カストディアンロール有効",
    ar: "✓ دور الوصي نشط"
  },
  "+ Activate Custodian Role": {
    it: "+ Attiva Ruolo Custode",
    en: "+ Activate Custodian Role",
    fr: "+ Activer Rôle Custode",
    es: "+ Activar Rol Custodio",
    pt: "+ Ativar Função Custódio",
    ru: "+ Активировать роль хранителя",
    hi: "+ कस्टोडियन भूमिका सक्रिय करें",
    bn: "+ কাস্টোডিয়ান ভূমিকা সক্রিয় করুন",
    zh: "+ 激活监护人角色",
    ja: "+ カストディアンロールを有効化",
    ar: "+ تفعيل دور الوصي"
  },
  "Search articles, keywords, tags or authors...": {
    it: "Cerca articoli, parole chiave, tag o autori...",
    en: "Search articles, keywords, tags or authors...",
    fr: "Rechercher des articles, mots-clés, tags ou auteurs...",
    es: "Buscar artículos, palabras clave, etiquetas o autores...",
    pt: "Pesquisar artigos, palavras-chave, tags ou autores...",
    ru: "Поиск статей, ключевых слов, тегов или авторов...",
    hi: "लेख, कीवर्ड, टैग या लेखक खोजें...",
    bn: "নিবন্ধ, কীওয়ার্ড, ট্যাগ বা লেখক খুঁজুন...",
    zh: "搜索文章、关键词、标签或作者...",
    ja: "記事、キーワード、タグ、著者を検索...",
    ar: "البحث عن المقالات أو الكلمات المفتاحية أو العلامات..."
  },
  "Published Articles": {
    it: "Articoli Pubblicati",
    en: "Published Articles",
    fr: "Articles Publiés",
    es: "Artículos Publicados",
    pt: "Artigos Publicados",
    ru: "Опубликованные статьи",
    hi: "प्रकाशित लेख",
    bn: "প্রকাশিত নিবন্ধ",
    zh: "已发布文章",
    ja: "公開済みの記事",
  ...
  "My News / Drafts": {
    it: "Le Mie Notizie / Bozze",
    en: "My News / Drafts",
    fr: "Mes Actualités / Brouillons",
    es: "Mis Noticias / Borradores",
    pt: "Minhas Notícias / Rascunhos",
    ru: "Мои новости / черновики",
    hi: "मेरा समाचार / ड्राफ्ट",
    bn: "আমার সংবাদ / খসড়া",
    zh: "我的新闻 / 草稿",
    ja: "下書き / マイニュース",
    ar: "أخباري / المسودات"
  ...
  "Featured on Cover": {
    ...
    fr: "En Vedette en Couverture",
    es: "Destacado en Portada",
    pt: "Destaque na Capa",
    ru: "Избранное на обложке",
    hi: "कवर पर विशेष",
    bn: "কভারে বৈশিষ্ট্যযুক্ত",
    zh: "封面精选",
    ja: "カバー特集",
    ar: "بارز في الغلاف"
  },
  ...
  "Read full article →": {
    ...
    hi: "पूरा लेख पढ़ें →",
    bn: "সম্পূর্ণ নিবন্ধ পড়ুন →",
    zh: "阅读全文 →",
    ja: "全文を読む →",
    ar: "قراءة المقال كاملاً ←"
  },
  "News Found": {
    it: "Notizie Trovate",
    en: "News Found",
    fr: "Articles Trouvés",
    es: "Noticias Encontradas",
    pt: "Notícias Encontradas",
    ru: "Найденные новости",
    hi: "समाचार मिले",
    bn: "সংবাদ পাওয়া গেছে",
    zh: "找到新闻",
    ja: "件のニュース",
    ar: "الأخبار найденные"
  },
  "Sorted by publication date": {
    it: "Ordinato per data di pubblicazione",
    en: "Sorted by publication date",
    fr: "Trie par date de publication",
    es: "Ordenado por fecha de publicación",
    pt: "Ordenado por data de publicação",
    ru: "Сортировка по дате публикации",
    hi: "प्रकाशन तिथि के अनुसार क्रमबद्ध",
    bn: "প্রকাশনার তারিখ অনুযায়ী সাজানো",
    zh: "按发布日期排序",
    ja: "出稿日順",
    ar: "مرتب حسب تاريخ النشر"
  },
  "No Articles Found": {
    ...
    bn: "কোন নিবন্ধ পাওয়া যায়নি",
    zh: "未找到文章",
    ja: "記事が見つかりません",
    ar: "لم يتم العثور على مقالات"
  },
  "All State News": {
    it: "Tutte le Notizie dello Stato",
    en: "All State News",
    fr: "Toutes les Actualités de l'État",
    es: "Todas las Noticias del Estado",
    pt: "Todas as Notícias do Estado",
    ru: "Все новости государства",
    hi: "सभी राज्य समाचार",
    bn: "সমস্ত রাজ্য সংবাদ",
    zh: "所有国家新闻",
    ja: "すべての国家ニュース",
    ar: "جميع أخبار الدولة"
  },
  "Verified by Digital Custodians": {
    it: "Verificato dai Custodi Digitali",
    en: "Verified by Digital Custodians",
    fr: "Vérifié par les Custodes Numériques",
    es: "Verificado por Custodios Digitales",
    pt: "Verificado por Custódios Digitais",
    ru: "Проверено цифровыми хранителями",
    hi: "डिजिटल कस्टोडियन द्वारा सत्यापित",
    bn: "ডিজিটাল কাস্টোডিয়ান দ্বারা যাচাইকৃত",
    zh: "已由数字监护人验证",
    ja: "デジタルカストディアン検証済み",
    ar: "تم التحقق بواسطة الأوصياء الرقميين"
  },
  "Share News": {
    it: "Condividi Notizia",
    en: "Share News",
    fr: "Partager l'Article",
    es: "Compartir Noticia",
    pt: "Compartilhar Notícia",
    ru: "Поделиться новостью",
    hi: "समाचार साझा करें",
    bn: "সংবাদ শেয়ার করুন",
    zh: "分享新闻",
    ja: "ニュースを共有",
    ar: "مشاركة الخبر"
  },
  ...
  "Attached Videos": {
    ...
    zh: "附加视频",
    ja: "添付動画",
    ar: "الفيديوهات المرفقة"
  },
  "Manage Article Categories": {
    it: "Gestione Categorie Articoli",
    en: "Manage Article Categories",
    fr: "Gérer les Catégories d'Articles",
    es: "Gestionar Categorías de Artículos",
    pt: "Gerenciar Categorias de Artigos",
    ru: "Управление категориями статей",
    hi: "लेख की श्रेणियों का प्रबंधन करें",
    bn: "নিবন্ধের বিভাগসমূহ পরিচালনা করুন",
    zh: "管理文章分类",
    ja: "記事カテゴリー管理",
    ar: "إدارة فئات المقالات"
  },
  "News Moderation Panel": {
    it: "Pannello Moderazione Notizie",
    en: "News Moderation Panel",
    fr: "Panneau de Modération des Actualités",
    es: "Panel de Moderación de Noticias",
    pt: "Painel de Moderação de Notícias",
    ru: "Панель модерации новостей",
    hi: "समाचार मॉडरेशन पैनल",
    bn: "সংবাদ মডারেশন প্যানেল",
    zh: "新闻审核面板",
    ja: "ニュースモデレーションパネル",
    ar: "لوحة إشراف الأخبار"
  },
