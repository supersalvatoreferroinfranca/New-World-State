...
export default function ArticleFormModal({
  ...
  const handleGenerateAIArticle = async () => {
    ...
    try {
      ...
      setAiSuccessMessage(tText('Article successfully generated by AI! You can review and customize the text below.', 'Articolo generato con successo dall\'AI! Puoi revisionare e personalizzare la bozza sottostante.'));
    } catch (err: any) {
